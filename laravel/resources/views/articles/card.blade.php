        ...
        <div class="card article-card">
                ...
                <div class="col-7">
                    <p class="mb-1">
                        <a href="{{ route('users.show', ['name' => $article->user->name]) }}"
                           class="font-weight-bold user-name-link text-dark mr-4">
                            {{ $article->user->name }}
                        </a>
                    ...
                    <div class="card-body pt-0">
                        <div class="card-text line-height px-3">
                            ...
                            <a href="{{ route('tags.show', ['name' => $tag->name]) }}"
                               class="border border-default text-default p-1 mr-1 mt-1 in-link">
                                {{ $tag->hashtag }}
                            </a>
                            @if($loop->last)
                        </div>
            ...
            <div class="card-footer py-1 d-flex justify-content-end bg-white">
                ...
                <div class="mr-3 d-flex align-items-center">
                    <a class="in-link p-1" href="{{ route('articles.show', ['article' => $article]) }}"><i
